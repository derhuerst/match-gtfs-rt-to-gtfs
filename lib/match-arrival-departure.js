import _mergeArrDep from 'find-hafas-data-in-another-hafas/merge-arr-dep.js'
const {
	createMergeDeparture,
	createMergeArrival,
} = _mergeArrDep
import {createFindArrivalDeparture as createFindArrDep} from './find-arrival-departure.js'
