...
import {csvPrinter as csv} from '../csv.js'
	...
	const onRoute = (r) => {
		const route = {
			...
			operator: {
				...
				// todo: make this proper agency_id & agency_name
		...
		for (const [id] of ids) { // todo: use specificity
			csv.write([r.route_id, id])
		}
	}
	return onRoute
}
