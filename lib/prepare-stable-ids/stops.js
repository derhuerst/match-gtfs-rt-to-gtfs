...
SELECT
	...
	stations_stable_ids.stable_id as station_stable_id
FROM stops_stable_ids
LEFT JOIN stops ON stops_stable_ids.stop_id = stops.stop_id
LEFT JOIN stops stations ON stops.parent_station = stations.stop_id
LEFT JOIN stops_stable_ids stations_stable_ids ON stations.stop_id = stations_stable_ids.stop_id
